...
//    slice.setAttribute('d', 'M 175 350 A 175 175 0 1 1 350 175');
//    var c = (value / 100) * 360;
//		if(c === 360) {c = 359.99};
...
Dial.prototype.createOverlay = function() {
    ...
    circle.setAttribute('cx', this.size / 2 + 'px');
    circle.setAttribute('cy', this.size / 2 + 'px');
...
containers[0].appendChild(dial.svg);
dial.animateStart();